...
public class CheckSession implements com.shipcore.sdk.IShipCore{
	...
	public TestResult execute(HashMap<String, String> inputs){
		...
		if(urlString.equals("www.shipcore.com") && portString.equals("80") && sslChoice.equals("Yes, allow SSL") && languageChoice.equals("English")){
			...
			tResult = new TestResult(TestResult.FAIL, "Error purging session data");
		}
	...
	public String getDescription(){
		return "Makes sure that all session data is purged after user logout.";
	}
